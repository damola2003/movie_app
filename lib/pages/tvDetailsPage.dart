...
class TvDetailsPage extends StatefulWidget {
  final int movieId;
  const TvDetailsPage({super.key, required this.movieId});
...
class _TvDetailsPageState extends State<TvDetailsPage> {
  ...
  late Future<SeriesDetailsClass> tvDetails;
  late Future<MovieRecommendationClass> tvRecommmendations;
  ...
  fetchInitiialData() {
    tvDetails = movieServices.getDetailTvSeries(widget.movieId);
    tvRecommmendations = movieServices.getMovieRecommendation(widget.movieId);
    setState(() {});
  }
}
